...
//
float Compute1DFractalNoise(float position, float scale = 1.f, unsigned int num_octaves = 1,
                            float octave_persistence = 0.5f, float octave_scale = 2.f, bool renormalize = true,
                            unsigned int seed = 0);
float Compute2DFractalNoise(float pos_x, float pos_y, float scale = 1.f, unsigned int num_octaves = 1,
                            float octave_persistence = 0.5f, float octave_scale = 2.f, bool renormalize = true,
                            unsigned int seed = 0);
float Compute3DFractalNoise(float pos_x, float pos_y, float pos_z, float scale = 1.f, unsigned int num_octaves = 1,
                            float octave_persistence = 0.5f, float octave_scale = 2.f, bool renormalize = true,
                            unsigned int seed = 0);
float Compute4DFractalNoise(float pos_x, float pos_y, float pos_z, float pos_t, float scale = 1.f,
                            unsigned int num_octaves = 1, float octave_persistence = 0.5f, float octave_scale = 2.f,
                            bool renormalize = true, unsigned int seed = 0);
...
// <renormalize>		If true, uses nonlinear (SmoothStep3) renormalization to within [-1,1]
//
float Compute1DPerlinNoise(float position, float scale = 1.f, unsigned int num_octaves = 1,
                           float octave_persistence = 0.5f, float octave_scale = 2.f, bool renormalize = true,
                           unsigned int seed = 0);
float Compute2DPerlinNoise(float pos_x, float pos_y, float scale = 1.f, unsigned int num_octaves = 1,
                           float octave_persistence = 0.5f, float octave_scale = 2.f, bool renormalize = true,
                           unsigned int seed = 0);
float Compute3DPerlinNoise(float pos_x, float pos_y, float pos_z, float scale = 1.f, unsigned int num_octaves = 1,
                           float octave_persistence = 0.5f, float octave_scale = 2.f, bool renormalize = true,
                           unsigned int seed = 0);
float Compute4DPerlinNoise(float pos_x, float pos_y, float pos_z, float pos_t, float scale = 1.f,
                           unsigned int num_octaves = 1, float octave_persistence = 0.5f, float octave_scale = 2.f,
                           bool renormalize = true, unsigned int seed = 0);
